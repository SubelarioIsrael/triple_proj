    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <section class="mb-10 mt-8">
            ...
            <div class="flex justify-between max-w-lg mx-auto">
                ...
                <input type="radio" id="very-satisfied" name="satisfaction" class="hidden">
                <label for="very-satisfied" class="icon">😊</label>

                <input type="radio" id="satisfied" name="satisfaction" class="hidden">
                <label for="satisfied" class="icon">🙂</label>

                <input type="radio" id="neutral" name="satisfaction" class="hidden">
                <label for="neutral" class="icon">😐</label>

                <input type="radio" id="dissatisfied" name="satisfaction" class="hidden">
                <label for="dissatisfied" class="icon">☹️</label>

                <input type="radio" id="very-dissatisfied" name="satisfaction" class="hidden">
        ...
        <section class="">
            <div class="text-center align">
                <button class="bg-bg_blue text-white py-3 px-6 rounded-lg hover:bg-blue-700">Submit Feedback</button>
            </div>
        </section>
    </div>
