                ...
                <div class="p-8 rounded-2xl bg-white shadow">
                    ...
                    <form class="mt-8 space-y-4">
                        ...
                        <div>
                            ...
                            <input name="contact" type="text" required class="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Enter your contact number" />
                        </div>
                        ...
                        <div>
                            ...
                            <input name="confirm-password" type="password" required class="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Confirm your password" />
                        </div>
                        ...
                        <div class="!mt-8">
                            <a href="{{ route('authentication.sign-in') }}" class="border text-white w-full py-3 px-4 text-sm tracking-wide rounded-lg bg-bg_blue hover:bg-gray-100  hover:text-bg_blue transition ease-in duration-200 focus:outline-none text-center block">
                                Sign Up
                            </a>
                        </div>

                        <p class="text-gray-800 text-sm mt-8 text-center">Already have an account? 
                           <a href="{{ route('authentication.sign-in') }}" class="text-blue-600 hover:underline ml-1 whitespace-nowrap font-semibold">Sign in</a>
                        </p>
                    </form>
                </div>
            </div>
